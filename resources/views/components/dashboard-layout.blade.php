...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item {{ Route::is('dashboard.pelangan*') ? 'active' : '' }}" >
        <a class="nav-link collapsed" href="/dashboard/pelangan">
          <i class="fas fa-fw fa-users "></i>
          <span>Pelangan</span>
        </a>
      </li>
      <li class="nav-item {{ Route::is('dashboard.produk*') ? 'active' : '' }}">
        <a class="nav-link collapsed" href="/dashboard/produk">
      ...
      <!-- Heading -->
       <li class="nav-item {{ Route::is('dashboard.penjualan*') ? 'active' : '' }}">
        <a class="nav-link collapsed" href="/dashboard/penjualan">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h5 class="mt-3">UKK KASIR APP</h5>
          <!-- Topbar Search -->
  ...
  <!-- Page level plugins -->  <script src="{{ asset('sb/vendor/datatables/jquery.dataTables.min.js') }}"></script>
